...
<body class="font-sans antialiased bg-slate-900 text-slate-800" x-data="{ showPass: false }">
    ...
    <div class="relative flex min-h-screen overflow-hidden">
        ...
        <div class="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-linear-to-br from-blue-700 via-indigo-700 to-slate-900 p-12 lg:flex">
            ...
            <div class="pointer-events-none absolute inset-0">
                ...
                <div class="float-2 absolute bottom-1/3 right-12 rotate-[4deg] rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm shadow-xl">
            ...
            <div class="relative z-10">
                ...
                <div class="mt-8 space-y-3">
                    @foreach([
                        ['Jadwal mingguan interaktif secara real-time', '📅'],
                        ['Permintaan tukar shift antar karyawan', '🔄'],
                        ['Laporan shift bulanan terperinci', '📊'],
                    ] as [$feat, $icon])
                        <div class="flex items-center space-x-3">
                            <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-white/10 text-sm">{{ $icon }}</span>
                    ...
                    <div class="fade-up fade-up-delay-2">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" @click="showPass = !showPass"
                                class="absolute right-3.5 top-3 text-slate-400 hover:text-slate-600 transition-colors focus:outline-none">
                                ...
                                <svg x-show="showPass" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" x-cloak>
